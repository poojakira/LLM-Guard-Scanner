...
# Cap scan length — very large inputs are themselves suspicious and
# running all these regexes on a 1MB string is a ReDoS waiting to happen
MAX_SCAN_LENGTH = 32_000  # ~8k tokens at 4 chars/token
